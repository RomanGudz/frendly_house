...
"use strict";var btnMenu=document.querySelector(".navigate__button-menu"),menuHeader=document.querySelector(".header__navigate"),svgmenu=document.querySelector(".navigate__button-menu-svg"),svgCloseMenu=document.querySelector(".navigate__button-menu-svg-close");btnMenu.addEventListener("click",(function(){menuHeader.classList.toggle("navigate__visually-hidden"),menuHeader.classList.toggle("navigate__visible"),svgmenu.classList.toggle("toggle-svg"),svgCloseMenu.classList.toggle("toggle-svg")}));var btnModalOpen=document.querySelectorAll("#btn-modal"),btnModalClose=document.querySelector(".modal__btn-close"),modalOverlay=document.querySelector(".modal-overlay");btnModalOpen.forEach((function(e){e.addEventListener("click",(function(){modalOverlay.classList.toggle("modal__overlay-visible"),btnModalClose.scrollIntoView({behavior:"smooth"})}))})),btnModalClose.addEventListener("click",(function(){modalOverlay.classList.toggle("modal__overlay-visible")})),modalOverlay.addEventListener("click",(function(e){e.target===modalOverlay&&modalOverlay.classList.toggle("modal__overlay-visible")})),menuHeader.addEventListener("click",(function(e){"header__item-link"===e.target.className&&(menuHeader.classList.toggle("navigate__visually-hidden"),menuHeader.classList.toggle("navigate__visible"),svgmenu.classList.toggle("toggle-svg"),svgCloseMenu.classList.toggle("toggle-svg"))}));var swiper1=new Swiper(".main-help__swiper",{direction:"horizontal",loop:!0,containerModifierClass:"swiper-wrapper",slidesPerView:"auto",centeredSlides:!1,spaceBetween:10,autoplay:{delay:1e3}}),swiper2=new Swiper(".our-pets__swiper",{direction:"horizontal",loop:!0,navigation:{nextEl:".pets__swiper-button-next",prevEl:".pets__swiper-button-prev"},containerModifierClass:"swiper-wrapper"}),swiper3=new Swiper(".main-help__swiper-two",{direction:"horizontal",loop:!0,containerModifierClass:"swiper-wrapper",slidesPerView:"auto",centeredSlides:!1,spaceBetween:10,autoplay:{delay:1e3}});function init(){var e=new ymaps.Map("map",{center:[55.847927,37.374884],zoom:17}),t=new ymaps.Placemark([55.847927,37.374884],{},{iconLayout:"default#image",iconImageHref:"img/mark.svg",iconImageSize:[39,59],iconImageOffset:[-19,-59]});t.events.add("mouseenter",(function(e){e.get("target").options.set("iconImageSize",[49,75]),e.get("target").options.set("iconImageOffset",[-24,-75])})).add("mouseleave",(function(e){e.get("target").options.set("iconImageSize",[39,59]),e.get("target").options.set("iconImageOffset",[-19,-59])})),e.geoObjects.add(t)}$((function(){$("#tabs").tabs({activate:function(e,t){$(".banner__tabs-list-item").removeClass("hidden-tab"),console.log(t);var a=t.newTab.find("a").attr("href");$('a[href="'+a+'"]').closest(".banner__tabs-list-item").addClass("hidden-tab")}});var e=$("#tabs").tabs("option","active");$(".banner__tabs-list-item").eq(e).addClass("hidden-tab")})),ymaps.ready(init);var form=$(".form-help__form")[0],modalForm=$(".form-help__form")[1];modalForm.addEventListener("submit",(function(e){e.preventDefault();var t=e.target,a={phone:t[0].value,email:t[1].value};$.ajax({url:"https://jsonplaceholder.typicode.com/posts",method:"post",dataType:"json",data:JSON.stringify(a),success:function(e){console.log(e),modalOverlay.classList.toggle("modal__overlay-visible")},error:function(e){console.log("exception: ",e)}})})),form.addEventListener("submit",(function(e){e.preventDefault();var t=e.target,a={phone:t[0].value,email:t[1].value};$.ajax({url:"https://jsonplaceholder.typicode.com/posts",method:"post",dataType:"json",data:JSON.stringify(a),success:function(e){console.log(e)},error:function(e){console.log("exception: ",e)}})}));
